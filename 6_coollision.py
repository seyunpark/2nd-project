...
# 화면 타이틀 설정
pygame.display.set_caption("WindDog Game")
...
enemy = pygame.image.load("D:/github/2nd-project/enemy.png")
...
# 캐릭터가 100 만큼 이동을 해야함
# 10 fps: 1초 동안에 10번 동작 -> 10만큼 10번 = 100
# 20 fps: 1초 동안에 20번 동작 -> 5만큼 20번 = 100
    ...
    for event in pygame.event.get():  # 어떤 이벤트가 발생했는가?
        ...
        if event.type == pygame.KEYUP:  # 방향기 떼면 멈춤
    ...
    if character_x_pos <0:  # 화면 밖으로 벗어나지 않게 설정
        character_x_pos = 0
